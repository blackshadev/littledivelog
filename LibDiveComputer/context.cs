...
namespace LibDiveComputer {
    ...
    public class Context : IDisposable {
        ...
        private static extern dc_status_t dc_context_new(ref IntPtr context);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern dc_status_t dc_context_free(IntPtr context);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern dc_status_t dc_context_set_loglevel(IntPtr context, dc_loglevel_t loglevel);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern dc_status_t dc_context_set_logfunc(IntPtr context, dc_logfunc_t logfunc, IntPtr userdata);
