...
namespace LibDiveComputer {
    ...
    public class Descriptor {
        ...
        private static extern uint dc_descriptor_get_type(IntPtr descriptor);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern uint dc_descriptor_get_model(IntPtr descriptor);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr dc_descriptor_get_vendor(IntPtr descriptor);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr dc_descriptor_get_product(IntPtr descriptor);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern void dc_descriptor_free(IntPtr descriptor);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern dc_status_t dc_descriptor_iterator(ref IntPtr iterator);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern dc_status_t dc_iterator_next(IntPtr iterator, ref IntPtr item);

        [DllImport(Constants.LibPath, CallingConvention = CallingConvention.Cdecl)]
        private static extern dc_status_t dc_iterator_free(IntPtr iterator);
